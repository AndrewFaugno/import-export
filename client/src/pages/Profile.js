            ...
            {loading ? (
                ...
                <>
                    {user.listings.length ? (
                        <h3 className="text-center py-2">Your Listings:</h3>
                    ) : (
                        <h3 className="text-center py-2">Created listings will be displayed here:</h3>
                    )}
                    <ProductList listings={user.listings} />
                </>
            )}
        </div>
    );
